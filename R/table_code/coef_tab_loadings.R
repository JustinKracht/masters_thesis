...
loading_mod_poly <- readRDS(paste0(project_dir, "/Data", "/loading_model_poly.RDS"))
...
coef_names <- list(
  ...
  "subjects_per_item:fa_methodfaml" = "Subjects/Item $\\times$ Extraction Method (ML)",
  "subjects_per_item:fa_methodfapa" = "Subjects/Item $\\times$ Extraction Method (PA)",
  ...
  "items_per_factor:fa_methodfaml" = "Items/Factor $\\times$ Extraction Method (ML)",
  "items_per_factor:fa_methodfapa" = "Items/Factor $\\times$ Extraction Method (PA)",
  ...
  "factors:fa_methodfaml" = "Factors $\\times$ Extraction Method (ML)",
  "factors:fa_methodfapa" = "Factors $\\times$ Extraction Method (PA)",
  ...
  "factor_loading:fa_methodfaml" = "Factor Loading $\\times$ Extraction Method (ML)",
  "factor_loading:fa_methodfapa" = "Factor Loading $\\times$ Extraction Method (PA)",
  ...
  "model_error:fa_methodfaml" = "Model Error $\\times$ Extraction Method (ML)",
  "model_error:fa_methodfapa" = "Model Error $\\times$ Extraction Method (PA)",
  ...
  "smoothing_methodAPA:fa_methodfaml" = "Smoothing Method (APA) $\\times$ Extraction Method (ML)",
  "smoothing_methodBY:fa_methodfaml" = "Smoothing Method (BY) $\\times$ Extraction Method (ML)",
  "smoothing_methodKB:fa_methodfaml" = "Smoothing Method (KB) $\\times$ Extraction Method (ML)",
  "smoothing_methodAPA:fa_methodfapa" = "Smoothing Method (APA) $\\times$ Extraction Method (PA)",
  "smoothing_methodBY:fa_methodfapa" = "Smoothing Method (BY) $\\times$ Extraction Method (PA)",
  "smoothing_methodKB:fa_methodfapa" = "Smoothing Method (KB) $\\times$ Extraction Method (PA)",
  ...
  "fa_methodfaml:I(subjects_per_item^2)" = "Extraction Method (ML) $\\times$ Subjects/Item$^2$",
  "fa_methodfapa:I(subjects_per_item^2)" = "Extraction Method (PA) $\\times$ Subjects/Item$^2$",
  "fa_methodfaml:I(factor_loading^2)" = "Extraction Method (ML) $\\times$ Factor Loading$^2$",
  "fa_methodfapa:I(factor_loading^2)" = "Extraction Method (PA) $\\times$ Factor Loading$^2$",
  "fa_methodfaml:I(factors^2)" = "Extraction Method (ML) $\\times$ Factors$^2$",
  "fa_methodfapa:I(factors^2)" = "Extraction Method (PA) $\\times$ Factors$^2$",
  "fa_methodfaml:I(model_error^2)" = "Extraction Method (ML) $\\times$ Model Error$^2$",
  "fa_methodfapa:I(model_error^2)" = "Extraction Method (PA) $\\times$ Model Error$^2$",
...
loading_coef_tab <- texreg::texreg(
  ...
  use.packages = FALSE,
  caption.above = TRUE,
  caption = "Coefficient estimates and standard errors for the linear and polynomial mixed effects models using $\\log[\\RMSE]$ as the dependent variable and estimating a random intercept for each indefinite correlation matrix.",
